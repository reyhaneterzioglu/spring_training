...
public class CarController {
    ...
    @RequestMapping("/info/{make}/{year}") // localhost:8080/info/honda   (path variable)  {}represents dynamic
    public String getCarInfo(@PathVariable("make") String car, @PathVariable int year) {
